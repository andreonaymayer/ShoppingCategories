...
public class CategoryTest {
    ...
    public void insertCategoryInList(){
        ...
        categoryRepo.addCategory("Category 1");
        categoryRepo.addCategory("Category 2");

        int actual = categoryRepo.getCategoryList().size();

        assertThat("The number of categories is correct", actual, is(2));
    }
    ...
    public void testCategoryDelete(){
        CategoryRepository categoryRepo = new CategoryRepository();
        categoryRepo.addCategory("Food");
        categoryRepo.addCategory("Drinks");
        categoryRepo.addCategory("Services");
    ...
    public void editCategory() {
        ...
        categoryRepo.editCategory("Food","Sports");
        String expected = categoryRepo.getCategoryList().get(0).getName();

        assertThat("The number of categories is correct", expected, is("Sports"));
